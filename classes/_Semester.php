...
class _Semester
{
	...
	*/
	...
	function assign_title()
	{
		...
		{$this->title = t("السنة الدراسية الأولى");}
		if ($this->semester_num == 1)
		{$this->title = t("السنة الدراسية الثانية");}
		if ($this->semester_num == 2)
		{$this->title = t("السنة الدراسية الثالثة");}
		if ($this->semester_num == 3)
		{$this->title = t("السنة الدراسية الرابعة");}
		if ($this->semester_num == 4)
		{$this->title = t("السنة الدراسية الخامسة");}
		
		// Still didn't find anything?
		if ($this->title == "") {
		  $this->title = t("السنة الدراسية") . " " . ($this->semester_num + 1);
		}
